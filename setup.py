...
setup(
  ...
  download_url = 'https://github.com/jonamelibia/pyimg-process/archive/refs/tags/1.3.4.tar.gz',    # I explain this later on
  keywords = ['Image proceessing', 'Easy to use', 'Simple'],   # Keywords that define your package best
